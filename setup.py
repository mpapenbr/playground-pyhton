...
setup(
    ...
    url='https://github.com/mpapenbr/playground-python',
    ...
    project_urls={
        ...
        'Changelog': 'https://python-playground.readthedocs.io/en/latest/changelog.html',
        'Issue Tracker': 'https://github.com/mpapenbr/playgound-python/issues',
    },
    keywords=[
